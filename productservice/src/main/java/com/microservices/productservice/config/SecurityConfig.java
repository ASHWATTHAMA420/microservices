...
import com.microservices.productservice.filter.CustomBearerTokenAuthenticationFilter;
import com.microservices.productservice.security.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    private static final String[] OPEN_URL = { "/swagger-ui/**","/api/public/**", "/eureka/**", "/webjars/swagger-ui/*",
            "/v3/api-docs/*", "/actuator/**", "/v3/api-docs"};
